...
password.addEventListener("input",function () {
  ...
  function submitCheck(){
    if(msg4.style.display == "none" || msg3.style.display == "none" || msg2.style.display == "none" || msg1.style.display == "none"){
        if(!isRequired(username) || !isRequired(email) || !isRequired(password) || !isRequired(cpassword)){
            return false
        }
        else{
            return true;
  ...
  document.getElementById("j").addEventListener("click", function(){
    if(flagU && flagCp && flagE && flagP){
        document.getElementById('f').setAttribute('action','home.html')  
    }
  })
